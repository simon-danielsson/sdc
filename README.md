...
Simply clone or copy-paste [sdc.h](./sdc.h) into your codebase and include it.
...
This project is licensed under the [MIT License](https://github.com/simon-danielsson/sdc/blob/main/LICENSE).  
